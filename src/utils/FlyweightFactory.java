...
public class FlyweightFactory<T>
{
	...
	{
		/*
		 * DONE Réucpération de l'élément dont la clé correspond à hash
	...
	{
		/*
		 * Insertion d'un élément "element" dans la map avec la clé
		 * correspondant à hash s'il n'existe pas déjà un tel élément dans la
		 * map
		 */
		T elt = map.putIfAbsent(hash, element);
	...
	{
		/*
		 * Compléter en utilisant get(hash) et si besoin put(hash, element) 
		 */
